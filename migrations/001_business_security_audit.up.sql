...
CREATE TABLE IF NOT EXISTS lobby_room_audits (
    ...
    action TEXT NOT NULL CHECK (action IN ('created', 'joined', 'matched', 'left', 'listed', 'snapshot_read', 'rules_read', 'ticket_read', 'create_retry', 'join_retry', 'cancelled', 'ready', 'disconnected', 'reconnected', 'unknown')),
    mode_id TEXT NOT NULL,
    user_id TEXT NOT NULL,
